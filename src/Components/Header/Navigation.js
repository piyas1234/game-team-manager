    ...
    return (
        ...
        <div>
            <Navbar className="p-3 pb-3 " expand="lg">
                <Navbar.Brand><h3><Link className="bg-primary text-white p-1" style={{ boxShadow: "3px 3px 3px 3px  gray", textDecoration: 'none', borderRadius: "60px", border: "3px solid gold" }} to="/"> <FontAwesomeIcon className="text-warning" icon={faBaseballBall} />Team manager</Link></h3></Navbar.Brand>
